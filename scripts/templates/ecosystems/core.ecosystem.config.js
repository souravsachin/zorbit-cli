  ...
  apps: [
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3006, NODE_OPTIONS: '--preserve-symlinks' },
    ...
    },
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3002, NODE_OPTIONS: '--preserve-symlinks' },
      max_memory_restart: '256M',
      ...baseLimits,
    },
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3021, NODE_OPTIONS: '--preserve-symlinks' },
      max_memory_restart: '256M',
      ...baseLimits,
    },
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3020, NODE_OPTIONS: '--preserve-symlinks' },
      max_memory_restart: '256M',
      ...baseLimits,
    },
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3022, NODE_OPTIONS: '--preserve-symlinks' },
      max_memory_restart: '256M',
      ...baseLimits,
    },
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3023, NODE_OPTIONS: '--preserve-symlinks' },
      max_memory_restart: '256M',
      ...baseLimits,
    },
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3004, NODE_OPTIONS: '--preserve-symlinks' },
      max_memory_restart: '256M',
      ...baseLimits,
    },
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3001, NODE_OPTIONS: '--preserve-symlinks' },
      max_memory_restart: '256M',
      ...baseLimits,
    },
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3003, NODE_OPTIONS: '--preserve-symlinks' },
      max_memory_restart: '256M',
      ...baseLimits,
    },
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      env: { NODE_ENV: 'production', PORT: 3005, NODE_OPTIONS: '--preserve-symlinks' },
      max_memory_restart: '256M',
      ...baseLimits,
    },
  ],
